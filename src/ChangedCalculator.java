...
public class ChangedCalculator {
    ...
    public static String calc(String input) {
        ...
        try {
            ...
            result += operation(leftOperand, rightOperand, sign);
    ...
    public static String operation(String leftOperand, String rightOperand, char sign) {
        String result = "";
        if (isArabic(leftOperand) && (isArabic(rightOperand))) {
            if (isAvailableSign(sign)) {
                ...
                if (isNumberInAvailableRange(localLeftOperand) && isNumberInAvailableRange(localRightOperand)) {
                    result += calculations(localLeftOperand, localRightOperand, sign);
                } else {
            ...
            if (isAvailableSign(sign)) {
                ...
                if (isNumberInAvailableRange(localLeftOperand) && isNumberInAvailableRange(localRightOperand)) {
                    result += arabicToRoman(calculations(localLeftOperand, localRightOperand, sign));
                } else {
